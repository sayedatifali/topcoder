...
public class LeaguePicks
{
	...
	{
		ArrayList<Integer> returnPicks = new ArrayList<Integer>();
		int pos;
		for (int i = 0; ; i++) {
			pos = position + 2*i*friends;
			if (pos <= picks)
				returnPicks.add(pos);
			else
				break;
		...
		int[] ret = new int[returnPicks.size()];
    	Iterator<Integer> iterator = returnPicks.iterator();
