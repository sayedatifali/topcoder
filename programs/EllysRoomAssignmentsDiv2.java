...
public class EllysRoomAssignmentsDiv2
{
	...
	{
		List<Integer> intRatings = new ArrayList<Integer>();
		Integer [] rating;
		StringTokenizer st;
		int ellys;
		int N;
		...
		st = new StringTokenizer(rat);
		while (st.hasMoreTokens()) {
			input = Integer.parseInt(st.nextToken());
			intRatings.add(input);
		}
		
		rating = intRatings.toArray(new Integer[intRatings.size()]);
		ellys = rating[0];
...
//		System.out.println("\nLen ================= " + len);
	...
	public int getIndex(Integer [] rating, int ellys) {
		int index;
		int low;
		int mid;
		int high;
